...
const GoogleIcon = () => (
 <svg viewBox="0 0 24 24" width="18" height="18" className="mr-2.5 shrink-0">
...
const GithubIcon = () => (
 <svg viewBox="0 0 24 24" width="18" height="18" className="mr-2.5 fill-current shrink-0">
...
export default function RegisterPage() {
 ...
 // Navigation handled by PublicRoute reacting to auth state change
 setLoading(false);
 };
 ...
 className="flex items-center gap-3 p-4 mb-4 rounded-xl bg-red-500/10 text-red-500 dark:text-red-400 text-sm font-semibold border border-red-500/20"
 >
