    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <Button
          ...
          className="w-full flex items-center justify-center bg-white dark:bg-zinc-800 text-foreground hover:bg-zinc-50 dark:hover:bg-zinc-700 border-border/50 shadow-sm transition-all h-12 rounded-xl"
        >
          <GoogleIcon />
