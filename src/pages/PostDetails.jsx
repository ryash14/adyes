...
export default function PostDetails() {
 ...
 <button
 onClick={() => { setIsSaved(s => !s); toast(isSaved ? 'Removed from saved' : 'Saved to your list!'); }}
 className={cn(
...
"flex-1 flex items-center justify-center gap-2 h-12 rounded-xl text-sm font-bold border transition-all duration-200",
 ...
 <div className="text-center py-12 rounded-xl border border-dashed border-border bg-secondary/30 mb-8">
 ...
 className="h-12 w-12 flex items-center justify-center rounded-xl bg-foreground text-background hover:bg-foreground/90 transition-colors disabled:opacity-40 disabled:pointer-events-none shadow-sm"
 >
 <Send size={18} />
 </button>
 </div>
