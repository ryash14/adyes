...
"Video Editing","Premiere Pro","After Effects","Final Cut Pro"
 ...
 <section className="bg-card backdrop-blur-md rounded-2xl border border-white/10 shadow-lg overflow-hidden relative group/section transition-all">
 <div className="absolute top-0 left-0 w-1 h-full bg-accent/50 opacity-0 group-hover/section:opacity-100 transition-opacity" />
 <div className="p-6 md:p-8 border-b border-white/5 bg-zinc-50 dark:bg-secondary/50">
 ...
 <input
 type="text"
 className="h-11 px-4 w-full bg-card backdrop-blur-md border border-border focus:border-accent/50 focus:ring-1 focus:ring-accent/50 transition-all outline-none rounded-xl text-sm font-medium text-foreground placeholder:text-muted-foreground/50 shadow-sm"
 ...
 {/* Bio & Skills Section */}
 <section className="bg-card backdrop-blur-md rounded-2xl border border-border shadow-lg overflow-hidden relative group/section transition-all">
 <div className="absolute top-0 left-0 w-1 h-full bg-accent/50 opacity-0 group-hover/section:opacity-100 transition-opacity" />
 <div className="p-6 md:p-8 border-b border-white/5 bg-secondary/50">
 ...
 <textarea
 className="w-full min-h-[140px] p-4 bg-card backdrop-blur-md border border-border focus:border-accent/50 focus:ring-1 focus:ring-accent/50 transition-all resize-y rounded-xl text-sm font-medium text-foreground outline-none placeholder:text-muted-foreground/50 shadow-sm"
 value={formData.bio}
 ...
 <div 
 className="flex flex-wrap items-center gap-2 p-3 min-h-[56px] rounded-xl border border-white/10 bg-card backdrop-blur-md focus-within:border-accent/50 focus-within:ring-1 focus-within:ring-accent/50 transition-all shadow-sm cursor-text"
 onClick={() => inputRef.current?.focus()}
 >
 {formData.skills.map((skill) => (
 <Badge key={skill} className="flex items-center gap-1.5 px-3 py-1 bg-white/5 text-foreground border border-border font-medium text-xs">
 {skill}
...
"text-left px-3 py-2.5 rounded-lg text-sm transition-colors",
 ...
 <label className="inline-flex h-11 items-center justify-center rounded-xl border border-border bg-white/5 px-6 text-sm font-medium text-foreground hover:bg-white/10 transition-colors cursor-pointer group relative overflow-hidden shadow-sm">
 <input
 type="file"
 accept=".pdf,.doc,.docx"
 ...
 <div className="flex rounded-xl overflow-hidden border border-white/10 bg-card backdrop-blur-md focus-within:border-accent/50 focus-within:ring-1 focus-within:ring-accent/50 transition-all shadow-sm">
 <span className="flex items-center px-4 bg-white/5 text-muted-foreground text-sm font-medium border-r border-border">
 github.com/
 </span>
 <input
 type="text"
