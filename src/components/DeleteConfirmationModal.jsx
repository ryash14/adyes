    ...
    <Modal open={open} onClose={onClose} title="Are you absolutely sure?" footer={footer}>
      <div className="space-y-4 pt-2">
        ...
        <div className="space-y-2">
          ...
          <input
            type="text"
            className="w-full bg-transparent border border-border/50 rounded-xl px-4 py-3 text-sm focus:border-destructive focus:ring-1 focus:ring-destructive outline-none transition-all"
            value={confirmText}
