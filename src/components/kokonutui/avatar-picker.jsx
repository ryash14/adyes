...
export default function ProfileSetup({
  ...
  return (
    <Card
      className={cn("relative mx-auto w-full max-w-[400px] border-border bg-card", className)}>
              ...
              {avatars.map((avatar) => {
                ...
                return (
                  <motion.button
                    ...
                    {isSelected && (
                      <div
                        className="absolute -right-0.5 -bottom-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-foreground">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className={cn("h-10 pl-9 text-sm", showError &&
