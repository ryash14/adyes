...
const IconsFeature = () => (
  <div className="mt-4 grid grid-cols-3 gap-4">
    <motion.div
      ...
      <span
        className="text-center font-medium text-neutral-600 text-xs group-hover:text-neutral-900 dark:text-neutral-400 dark:group-hover:text-neutral-200">
        OpenAI
      </span>
    </motion.div>
    <motion.div
    ...
    <motion.div
      ...
      <div className="relative flex h-8 w-8 items-center justify-center">
        <Plus
          className="h-6 w-6 text-neutral-600 transition-transform dark:text-neutral-400" />
      </div>
      <span
        className="text-center font-medium text-neutral-600 text-xs group-hover:text-neutral-900 dark:text-neutral-400 dark:group-hover:text-neutral-200">
        More
  ...
  <div className="relative mt-3">
    ...
    {timeline.map((item) => (
      <motion.div
        ...
        <div
          className="z-10 mt-0.5 h-5 w-5 flex-shrink-0 rounded-full border-2 border-neutral-300 bg-neutral-100 dark:border-neutral-600 dark:bg-neutral-800" />
        <div>
      ...
      {metrics.map((metric, index) => (
        <motion.div
          ...
          <div className="flex items-center justify-between text-sm">
            <div
              className="flex items-center gap-1.5 font-medium text-neutral-700 dark:text-neutral-300">
        ...
        <div
          ...
          <div className="flex flex-1 flex-col space-y-2">
            <div className="flex items-center justify-between">
              <h3
                className="font-semibold text-neutral-900 text-xl tracking-tight transition-colors duration-300 group-hover:text-neutral-700 dark:text-neutral-100 dark:group-hover:text-neutral-300">
                {item.title}
              </h3>
              <div
                className="text-neutral-400 opacity-0 transition-opacity duration-200 group-hover:opacity-100 dark:text-neutral-500">
            ...
            {item.icons && !item.feature && (
              <div
                className="mt-auto flex flex-wrap items-center gap-4 border-neutral-200/70 border-t pt-4 dark:border-neutral-800/70">
                <OpenAI
                  className="h-5 w-5 opacity-70 transition-opacity hover:opacity-100 dark:hidden" />
                <OpenAIDark
                  className="hidden h-5 w-5 opacity-70 transition-opacity hover:opacity-100 dark:block" />
                <AnthropicDark
                  className="hidden h-5 w-5 opacity-70 transition-opacity hover:opacity-100 dark:block" />
                <Anthropic
                  className="h-5 w-5 opacity-70 transition-opacity hover:opacity-100 dark:hidden" />
...
export default function BentoGrid({ items = [] }) {
  ...
  return (
    <section className="relative overflow-hidden bg-background py-8 sm:py-12">
