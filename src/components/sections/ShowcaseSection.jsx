        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col">
            ...
            <div className="flex-1 flex p-4 gap-4">
              <div className="w-48 h-full bg-zinc-800 rounded-lg border-2 border-border/50 animate-pulse hidden md:block"></div>
              <div className="flex-1 h-full bg-zinc-800 rounded-lg border-2 border-border/50 animate-pulse delay-75"></div>
              <div className="w-64 h-full bg-zinc-800 rounded-lg border-2 border-border/50 animate-pulse delay-150 hidden lg:block"></div>
            </div>
          </div>
