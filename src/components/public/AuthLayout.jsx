...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row overflow-hidden selection:bg-accent selection:text-white dark:selection:text-black">
      {/* Left Pane - Art/Brand */}
      <div className="hidden md:flex md:w-1/2 lg:w-5/12 bg-zinc-50 dark:bg-zinc-950 border-r border-border p-12 flex-col justify-between relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 md:p-10 relative z-10 bg-background h-screen overflow-y-auto">
        ...
        >
          ...
          <div className="bg-white/70 dark:bg-zinc-900/40 border border-border/50 shadow-xl shadow-black/5 dark:shadow-2xl dark:shadow-black/50 p-6 sm:p-8 rounded-2xl backdrop-blur-xl">
            {children}
          </div>
